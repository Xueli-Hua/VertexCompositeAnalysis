...
dimuana = cms.EDAnalyzer('PATCompositeTreeProducer',
  ...
  eventFilterNames = cms.untracked.vstring(
      ...
      'Flag_hfCoincFilter1Th4',
      'Flag_hfCoincFilter3Th4',
      'Flag_hfCoincFilter4Th4',
      'Flag_hfCoincFilter5Th4',
      'Flag_hfCoincFilter1Th3',
      'Flag_hfCoincFilter2Th3',
      'Flag_hfCoincFilter3Th3',
      'Flag_hfCoincFilter4Th3',
      'Flag_hfCoincFilter5Th3',
      'Flag_hfCoincFilter1Th5',
      'Flag_hfCoincFilter2Th5',
      'Flag_hfCoincFilter3Th5',
      'Flag_hfCoincFilter4Th5',
      'Flag_hfCoincFilter5Th5',
      'Flag_hfCoincFilter1Th6',
      'Flag_hfCoincFilter2Th6',
      'Flag_hfCoincFilter3Th6',
      'Flag_hfCoincFilter4Th6',
      'Flag_hfCoincFilter5Th6',
  ),
