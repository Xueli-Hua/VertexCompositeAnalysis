...
#from CohJpsiFileList import MCFileNames
# Define the input source
process.source = cms.Source("PoolSource",
    #fileNames = cms.untracked.vstring(MCFileNames),
    fileNames = cms.untracked.vstring(
        'root://cms-xrd-global.cern.ch//store/mc/HINPbPbSpring23Reco/GGToCoherentJPsiToMuMu_TuneCP5_5p36TeV_starlight-pythia8/AODSIM/132X_mcRun3_2023_realistic_HI_v9-v2/2820000/00f8aa31-0fbe-4507-99e5-87545d7a45cc.root',
    ),
)
...
process.EvtPlaneHF = cms.EDAnalyzer('HiEventPlaneHFbyTower',
...
process.evtplaneHF = cms.Sequence(process.EvtPlaneHF)
process.evtplaneHF_step = cms.Path(process.cent_seq * process.eventFilter_HM * process.evtplaneHF)

# Define the output
process.TFileService = cms.Service("TFileService", fileName = cms.string('dimuanamc_officalCohAOD.root'))
...
process.schedule = cms.Schedule(
    ...
    process.evtplaneHF_step,
    process.p
)

# Add the event selection filters
process.Flag_colEvtSel = cms.Path(process.cent_seq * process.eventFilter_HM * process.colEvtSel)
process.Flag_hfCoincFilter2Th4 = cms.Path(process.cent_seq * process.eventFilter_HM * process.hfCoincFilter2Th4)
