...
process.EvtPlaneTrk = cms.EDAnalyzer('PATEventPlaneTrack',
...
process.evtplaneTrk_step = cms.Path(process.eventFilter_HM * process.evtplaneTrk)

# Define the output
process.TFileService = cms.Service("TFileService", fileName = cms.string('dimuana_Trk.root'))
